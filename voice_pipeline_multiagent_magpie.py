...
DS_VOICE = os.getenv("MAGPIE_DS_VOICE", "Magpie-Multilingual.EN-US.Aria")
IT_VOICE = os.getenv("MAGPIE_IT_VOICE", "Magpie-Multilingual.EN-US.Jason")
...
LANGUAGE_PRESETS: dict[str, dict] = {
    "en": {
        ...
        "tts_language": "en-US",
        "ds_voice": os.getenv("MA_DS_VOICE_EN", "Magpie-Multilingual.EN-US.Aria"),
        "it_voice": os.getenv("MA_IT_VOICE_EN", "Magpie-Multilingual.EN-US.Jason"),
    },
    "fr": {
        "label": "Fran\u00e7ais",
        "flag": "\U0001F1EB\U0001F1F7",
        "tts_language": "fr-FR",
        "ds_voice": os.getenv("MA_DS_VOICE_FR", "Magpie-Multilingual.FR-FR.Louise"),
        "it_voice": os.getenv("MA_IT_VOICE_FR", "Magpie-Multilingual.FR-FR.Pascal"),
    },
    "de": {
        "label": "Deutsch",
        "flag": "\U0001F1E9\U0001F1EA",
        "tts_language": "de-DE",
        "ds_voice": os.getenv("MA_DS_VOICE_DE", "Magpie-Multilingual.DE-DE.Mia"),
        "it_voice": os.getenv("MA_IT_VOICE_DE", "Magpie-Multilingual.DE-DE.Pascal"),
    },
    "es": {
        "label": "Espa\u00f1ol",
        "flag": "\U0001F1EA\U0001F1F8",
        "tts_language": "es-US",
        "ds_voice": os.getenv("MA_DS_VOICE_ES", "Magpie-Multilingual.ES-US.Isabela"),
        "it_voice": os.getenv("MA_IT_VOICE_ES", "Magpie-Multilingual.ES-US.Diego"),
    },
    "it": {
        "label": "Italiano",
        "flag": "\U0001F1EE\U0001F1F9",
        "tts_language": "it-IT",
        "ds_voice": os.getenv("MA_DS_VOICE_IT", "Magpie-Multilingual.IT-IT.Isabela"),
        "it_voice": os.getenv("MA_IT_VOICE_IT", "Magpie-Multilingual.IT-IT.Pascal"),
    },
}
...
<title>NVIDIA Multi-Agent Voice (Magpie)</title>
...
<div class="header">
  <div class="brand">
    ...
    <h1>Multi-Agent Voice <span style="color:var(--nv-text-muted);font-weight:400;font-size:12px">Magpie</span></h1>
  </div>
